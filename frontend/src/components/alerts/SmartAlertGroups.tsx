...
import { Layers, BellOff, ChevronDown, Clock, AlertTriangle } from 'lucide-react'
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-lg font-bold text-white">Smart Alert Groups</h2>
                ...
                {groups.map((g, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            style={{
                                background: isSnoozed ? 'rgba(255,255,255,0.015)' : `${sev.color}06`,
                                border: `1px solid ${isSnoozed ? 'rgba(255,255,255,0.05)' : sev.color + '20'}`,
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`p-2 rounded-lg text-xs transition-all ${isSnoozed ? 'bg-indigo-500/20 text-indigo-300' : 'hover:bg-white/5 text-gray-500'}`}
                                    ...
                                    >
                                        <div className="border-t border-white/5 px-4 pb-4">
                                            {g.alerts.map((a, j) => {
                                                ...
                                                return (
                                                    <div key={a.id} className="flex items-start gap-3 py-3 border-b border-white/[0.03] last:border-b-0">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center gap-2 mb-0.5">
                                                                ...
                                                                <span className="text-[9px] px-1 py-0.5 rounded" style={{ color: aSev.color, background: `${aSev.color}12` }}>
                                                                    {aSev.label}
                                                                </span>
                                                            </div>
