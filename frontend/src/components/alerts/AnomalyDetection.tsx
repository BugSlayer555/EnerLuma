    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <span className="ml-auto text-[10px] bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full font-semibold">ML-Powered</span>
            </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-start gap-3 mb-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 flex-wrap mb-1">
                                        <h3 className="text-sm font-bold text-white">{a.device}</h3>
                                    ...
                                    <p className="text-xs text-gray-400">{a.metric}</p>
                                </div>
                                ...
                                <div className="flex flex-col items-center">
                                    <div className="relative w-14 h-14 flex items-center justify-center">
                                        ...
                                        <span className="absolute text-xs font-bold text-white">{a.confidence}%</span>
                                    </div>
                                    <span className="text-[8px] text-gray-500 mt-0.5">Confidence</span>
                                </div>
                            </div>

                            <p className="text-[11px] text-gray-400 leading-relaxed mb-3">{a.description}</p>

                            {/* Deviation metrics */}
                            <div className="flex items-center gap-4 mb-3 flex-wrap">
                                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/20">
                                    <TrendingUp className="w-3.5 h-3.5 text-red-400" />
                                    <span className="text-xs font-bold text-red-400">+{a.deviation}%</span>
                                    <span className="text-[10px] text-gray-500">deviation</span>
                                </div>
                                <div className="text-xs text-gray-400">
                                    Expected: <span className="text-gray-300 font-medium">{a.expected}</span>
                                    <span className="mx-1.5 text-gray-600">→</span>
                                    Actual: <span className="text-red-400 font-medium">{a.actual}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2 p-3 rounded-lg bg-teal-500/[0.06] border border-teal-500/15">
                                ...
                                <div>
                                    <span className="text-[10px] text-teal-400 font-semibold">Suggested Action</span>
                                    <p className="text-[11px] text-gray-400">{a.suggestedAction}</p>
                                </div>
