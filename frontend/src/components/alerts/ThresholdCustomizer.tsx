    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-lg font-bold text-white">Threshold Configuration</h2>
                ...
                {configs.map((c, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            style={{
                                background: c.enabled ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.01)',
                                border: `1px solid ${c.enabled ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.04)'}`,
                        ...
                        >
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h3 className="text-sm font-semibold text-white">{c.device}</h3>
                            ...
                            {c.enabled && (
                                <>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="h-2 rounded-full bg-gray-700/60 overflow-hidden relative">
                                            <motion.div
                                            ...
                                            />
                                            {/* Threshold marker */}
                                            <div className="absolute top-0 w-0.5 h-full bg-white/30" style={{ left: '100%' }} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-1 rounded-full appearance-none bg-gray-700 cursor-pointer accent-teal-500"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {[
                                            ...
                                            return (
                                                <span key={ch.key}
                                                    className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-medium cursor-pointer transition-all ${active ? 'bg-teal-500/20 text-teal-300 border border-teal-500/30' : 'text-gray-600 border border-transparent hover:text-gray-400'}`}>
